...
def plot_data_and_fit(position_timestamps: np.ndarray, part_positions: np.ndarray, force_timestamps: np.ndarray, forces: np.ndarray) -> None:
...
if __name__ == "__main__":
    ...
    CHECK_PEAKS = 1
    PLOT_DATA = 2
    PLOT_ALL_VELOCITIES = 3
    ACTION = PLOT_ALL_VELOCITIES
    ...
    if ACTION == PLOT_ALL_VELOCITIES:
        ...
        plt.ylabel("Average Velocity (mm/s)", fontsize=18)
